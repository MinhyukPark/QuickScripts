...
def collapse_root_helper(input_tree, output_file, hide_prefix):
...
def collapse_root(input_tree, output_file, hide_prefix):
    """This script resolves the input tree
    """
    collapse_root_helper(input_tree, output_file, hide_prefix)
